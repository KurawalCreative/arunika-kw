        ...
        <div className="w-full">
            <div ref={ref} className="relative flex min-h-screen flex-col items-center justify-center">
                ...
                <motion.div style={{ y: mapY }} className="pointer-events-none absolute mt-48 w-full md:mt-40 lg:mt-32">
                    <div className="relative mx-auto aspect-video max-w-[1400px]">
                        ...
                        <div className="relative aspect-video w-full">
                            <div className="absolute bottom-[47%] left-[17%]">
                            ...
                            <div className="absolute bottom-[20%] left-[47%]">
                ...
                <div className="relative mx-auto mb-48 flex max-w-7xl flex-col items-center justify-center gap-6 px-4 md:mb-40 lg:mb-32">
                    <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.2 }} className="w-full max-w-6xl text-center text-3xl leading-tight font-extrabold text-gray-900 sm:text-4xl md:text-5xl dark:text-white">
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.5 }} className="relative max-w-[749px] text-center">
                        <p className="relative text-base text-gray-700 sm:text-lg dark:text-gray-300">Dari dongeng ajaib, pakaian adat, hingga sejarah daerah semua bisa kamu jelajahi bersama Arunika, tempat belajar budaya yang seru, interaktif, dan penuh warna!</p>
                        <div className="absolute -top-3 -right-3 hidden sm:block">
                            <Image src={petik} alt="_" width={27} height={23} />
                        </div>
                    </motion.div>
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.7 }}>
                        <Link href={"/"} className="bg-primary-blue hover:bg-primary-blue-hover flex items-center justify-center gap-3 rounded-full py-1 pr-1 pl-4 text-sm font-normal text-white transition-colors sm:text-base dark:bg-blue-600 dark:hover:bg-blue-700">
                            Mulai Jelajah{" "}
