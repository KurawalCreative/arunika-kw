                            ...
                            <div className="flex w-full max-w-sm flex-1 flex-col gap-4">
                                <div className="flex flex-col gap-2 text-center">
                                    ...
                                    <div className="text-TextSecondary text-sm">
                                        Temukan kembali cerita, tradisi, dan keindahan dari setiap penjuru negeri.
                                    </div>
                                </div>
                                ...
                                <div className="flex w-sm flex-col gap-4 lg:flex-row">
                                    <button
                                        ...
                                        className="flex h-10.5 w-full cursor-pointer items-center justify-center gap-2 rounded-full border-2 border-[#E0E1E2] bg-[#F9FAFB]"
                                    >
                                ...
                                <div className="mt-1 flex w-full flex-col gap-1">
                                    <input
                                        ...
                                        placeholder="Masukan email atau username kamu"
                                        className="text-TextPrimary h-10.5 rounded-xl border-2 border-gray-300 bg-white px-3 text-sm placeholder:text-gray-400"
                                    />
                                </div>
                                ...
                                <div className="mt-2 w-sm">
                                    <button
                                        onClick={handleLogin}
                                        className="bg-orange h-10.5 w-full cursor-pointer rounded-full font-semibold text-white"
                                    >
                                        Login
                                    </button>
                                </div>
